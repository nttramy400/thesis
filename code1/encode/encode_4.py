...
def getSeqListFromH5File(filename= "..//outputfile//"+version+"//info.h5"):
...
def buildRelationalMatrixToH5File(seqList, listFeature, filename = "..//outputfile//"+version+"//encodingFile.h5"):
...
def replaceRelationalMatFromH5File(newFeatureRowMatrix, filename = "..//outputfile//"+version+"//encodingFile.h5"):
...
def saveInfoFeatureToH5File(listFeature,sizeOfSubstr=range(2,41), filename = "..//outputfile//"+version+"//encodingFile.h5"):
    fileh = tables.open_file(filename, mode="a")
    root = fileh.root
