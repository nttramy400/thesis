...
listSubStr = filter(lambda key: dictSubString[key] > -1, dictSubString) #lay cac subSeq co tan so xuat hien > 10
...
#
#count2 = 0
#listDuplicateFeatureRowIndex1 = []
#setDuplicateFeatureIndex = set()
#
#            
#featureRowMatrix= np.delete(featureRowMatrix,list(setDuplicateFeatureIndex),axis = 0)
#listSubStr= np.delete(np.array(listSubStr),list(setDuplicateFeatureIndex),axis = 0)
#
#
